    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
               ...
               <div class="mb-3">
                  <label for="cAddress<?php echo $client['client_id'];?>" class="form-label">Client Address</label>
                  <input type="text" class="form-control" id="cAddress<?php echo $client['client_id'];?>" name="cAddress" value="<?php echo $client['client_address'];?>">
                </div>
