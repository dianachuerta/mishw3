<div class="row mb-4">
  <div class="col">
    <h1 class="text-center" style="color: #6A5ACD; font-family: 'Arial', sans-serif; font-weight: bold;">Hospitals</h1>
  </div>
  <div class="col-auto">
...
<div class="table-responsive">
  <table class="table table-bordered table-striped table-hover" style="background-color: #f3f4f7;">
    <thead class="thead-dark" style="background-color: #6A5ACD; color: white;">
      <tr>
        <th>ID</th>
        <th>Name</th>
        <th>Location</th>
      ...
      <tr>
        ...
        <td>
          <form method="post" action="">
            ...
            <button type="submit" class="btn" style="background-color: #FF1493; color: white;" onclick="return confirm('Are you sure?');">
